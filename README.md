...
buildConfigField "String", "BASE_URL", '"BASE URL HERE"'
buildConfigField "String", "CLIENT_SECRET", '"CLEINT SCRENT"'
...
string.xml
```
<string name="app_name" translatable="false">Handy User</string>
